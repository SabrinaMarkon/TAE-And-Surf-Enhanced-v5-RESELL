...
if( session_is_registered("alogin") ) {
        ...
        echo "<center><H2>All Top Navigation Links</H2></center>";
       $query = "SELECT COUNT(*) as num FROM topnav";
                  $total_pages = mysql_fetch_array(mysql_query($query));
	$total_pages = $total_pages[num];

        $query = "select * from topnav ORDER BY userid";
		$result = mysql_query ($query)
	     	or die ("Query failed");

 echo "<font size=2 face='$fonttype' color='$fontcolour'><p><center>";
    echo "<center><p><b>";
   echo "$total_pages Top Nav Links Found";
    echo "</center></p></b>";
mysql_close($dblink);
    ?>
        ...
        ?><tr>
         ...
         <td bgcolor="<? echo $basecolour; ?>"><center><font size=2 face="<? echo $fonttype; ?>" color="<? echo $fontcolour; ?>"><br><a href="sitecheck.php?url=<? echo $url; ?>" target="_blank">ad link</a></font></center></td>
		  ...
		  <td bgcolor="<? echo $basecolour; ?>"><center>
            <form method="POST" action="deletetopnav.php">
