...
<table>
       ...
       echo "<center><H2>Automated Member Transactions</H2></center>";
        ...
        ?>
 <form action="deletetransactions.php" method=POST name=paytrans>
...
<td bgcolor="#000000"><center><font size=2 face="<? echo $fonttype; ?>" color="#FFFFFF">ID</font></center></td>
  ...
  <td bgcolor="#000000"><center><font size=2 face="<? echo $fonttype; ?>" color="#FFFFFF">Amount</font></center></td>
