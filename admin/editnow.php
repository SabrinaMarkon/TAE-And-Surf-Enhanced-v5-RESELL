...
$safepay_emailp = $_POST['safepay_email'];
...
if( session_is_registered("alogin") ) {
    ...
    if (empty($name)) {
   	...
   	$query .= "subscribed_email='$contact_emailp',alertpay_email='$alertpay_emailp',safepay_email='$safepay_emailp',moneybookers_email='$moneybookers_emailp',";
