<?php
	...
	$ipn_data = array();         /* array to hold POST values from AlertPay IPN */

	include "config.php";
               

	/* check the security code sent with the post to ensure that the post came from AlertPay */
...
{
$alertpay_status = "Success";
}
if ($oto['priceinterval'] != "onetime")
{
$alertpay_status = "Subscription-Payment-Success";
}

if ($ap_status == $alertpay_status)
{
