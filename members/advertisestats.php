...
?>
		...
		<br><HR ALIGN= "center" size= 10 WIDTH= 75% COLOR= "#000000" NO SHADE>
...
<br>
	          ...
	          ?>
	            <TR>
					...
					<td bgcolor="<? echo $basecolour; ?>"><font size=2 face="<? echo $fonttype; ?>" color="<? echo $fontcolour; ?>"><center>
	                    <? 
						if($hheadlineadclicks >= $hheadlineadmax) echo "campaign completed<form method=\"post\"><input type=\"hidden\" name=\"delhheadlinead\" value=\"$hheadlineadid\"><input type=\"submit\" value=\"Delete\"></form>"; 	
...
?>
					...
					<td bgcolor="<? echo $basecolour; ?>"><font size=2 face="<? echo $fonttype; ?>" color="<? echo $fontcolour; ?>"><center>
	                    <? 
						if($hheaderadclicks >= $hheaderadmax) echo "campaign completed<form method=\"post\"><input type=\"hidden\" name=\"delhheaderad\" value=\"$hheaderadid\"><input type=\"submit\" value=\"Delete\"></form>"; 	
	        ...
	        ?><br>
			  ...
			  <?
			    ...
			    if ($numrows5 == 0) {
					...
					{
			        ?>
			          <a href="addsolos.php">Click here</a> to set these up now.
			        <?
			    } else {
					?>
					 But you have to wait until your last solo has been sent to submit another one.
					<?
				}
					} # if(($lastsolopost != $today) or ($memtype != "PRO"))
					else
					{
					?>
					Pro members may post once per day, and you have already sent out a solo ad today.<br>Please return tomorrow or upgrade for unlimited daily solo sends!
					<?php
					}
			  ?>
			  </font></p></b>
