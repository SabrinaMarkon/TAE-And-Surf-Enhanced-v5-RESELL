...
if (isset($_POST['SafepayEmail'])) {
   $safepayemail = $_POST['SafepayEmail'];
}
...
if( ($userid<>"")&&($password<>"") ) {
	...
	if(strpos($contactemail, "@")) {
	    ...
	    $query .= "pword='$password',name='$name',lastname='$lastname',contact_email='$contactemail',subscribed_email='$contactemail',paypal_email='$paypalemail',alertpay_email='$alertpayemail',safepay_email='$safepayemail',moneybookers_email='$moneybookersemail',solos='$solo'";
