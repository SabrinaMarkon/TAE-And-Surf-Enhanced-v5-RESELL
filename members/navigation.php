...
?>
<table align=center width="900" bgcolor=#F4D223><tr><td><center>
...
<b>You currently have<font color=BLUE> <? echo $surfcredits; ?> surf credits!  </font>SURF TO EARN MORE CREDITS!</b><hr>
...
{
?>
<table align="center" width="880" cellpadding=2 cellspacing=0 bgcolor="#FFFFFF" border=1>
<?php
if ($hheadlinerows > 0)
{
...
?>
<tr>
<td width=480 bgcolor="<?php echo $hheaderbgcolor ?>" align="center"><a target="_blank" href="./hheaderadclicks1.php?id=<?php echo $hheaderid ?>" target=\"_blank\">
<img src="<?php echo $hheaderbanner ?>" border="0" height="60" width="468"></a></td>
<td bgcolor="<?php echo $hheaderbgcolor ?>"><div style="width: 300px; padding: 2px; overflow:auto; background: <?php echo $hheaderbgcolor ?>; color: <?php echo $hheaderheadingfontcolor ?>;"><b><a style="color:<?php echo $hheaderheadingfontcolor ?>" target="_blank" href="./hheaderadclicks1.php?id=<?php echo $hheaderid ?>"><?php echo $hheaderheading ?></a></b></div><div style="width: 300px; height: 60px; padding: 2px; overflow:auto; background: <?php echo $hheaderbgcolor ?>; color: <?php echo $hheaderdescriptionfontcolor ?>;"><?php echo $hheaderdescription ?></div></td>
</tr>
<?php
} # while($hheaderinfo = mysql_fetch_array($hheaderresult2))
?>
    ...
    while ($navline = mysql_fetch_array($navresult)) {
		...
		$navname = $navline["name"];
	       ...
	       if ($navline["memtype"]==$memtype OR $navline["memtype"]==""){
	        ...
	        <center><table border=1 cellpadding=0 cellspacing=0 width=165 height=26><tr valign=middle><td align="center" nowrap style="background:white" onMouseDown="this.style.backgroundImage='url(/images/button2.jpg)'" onMouseOver="this.style.backgroundColor='<? echo $nav_hover; ?>'" onMouseOut="this.style.backgroundColor='#FFFFFF'"><a href="<? echo $navurl; ?>" class="button" target="_blank" onmouseover="window.status='<? echo $navname; ?>';return true" onMouseOut="window.status='';return true"><font color="#000000">&nbsp;&nbsp;&nbsp;<? echo $navname; ?>&nbsp;&nbsp;&nbsp;</font></a></td></tr></table>
			<?
	        ...
	        <center><table border=0 cellpadding=0 cellspacing=0 width=165 height=30><tr valign=middle><td align="center" wrap style="background-image:url('<?php echo $domain ?>/images/button2.png')" onMouseDown="this.style.backgroundImage='url(<?php echo $domain ?>/images/button3.png)'" onMouseOver="this.style.backgroundImage='url(<?php echo $domain ?>/images/button3.png)'"onMouseOut="this.style.backgroundImage='url(<?php echo $domain ?>/images/button2.png)'"><a href="<? echo $navurl; ?>" class="button" onmouseover="window.status='<? echo $navname; ?>';return true" onMouseOut="window.status='';return true"><font color="#000000">&nbsp;&nbsp;&nbsp;<? echo $navname; ?>&nbsp;&nbsp;&nbsp;</font></a></td></tr></table>
			<?					
