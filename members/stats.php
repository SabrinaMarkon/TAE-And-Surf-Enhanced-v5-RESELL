...
if( session_is_registered("ulogin") )
   	{  // members only stuff!
        ...
        //current earnings.....
        if ($commission>0) {
        	echo "<p><b>You are owed $".round($commission,2).". Commissions are paid on the 15th of every month.  <br>Make sure you have your PayPal or AlertPay email filled out under Edit My Details.</p></b>";
        }
