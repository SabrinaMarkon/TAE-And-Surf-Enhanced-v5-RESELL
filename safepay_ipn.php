...
/* check the security code sent with the post to ensure that the post came from SafePay */





	if ($safepay_passphrase == $_POST['passPhrase']){




		$userid = $_POST['custom1'];
		...
		if ($numrows == 1) {
			...
			if($item == $sitename." One-Time Offer") {
				...
				mysql_query("INSERT INTO transactions VALUES ('id','".$userid."','Safepay payment - OTO','".time()."','$amount\$')");
  ...
  if($oto['hotlink_num'] AND $oto['hotlink_views']) {
 	...
 	if($oto['solo_num']) {
				...
				mysql_query("INSERT INTO transactions VALUES ('id','".$userid."','Safepay payment - 1000 points','".time()."','$amount\$')");
			...
			elseif($item == $sitename." Solo Ad ".$userid) {
				mysql_query("INSERT INTO transactions VALUES ('id','".$userid."','Safepay payment - Solo Ad','".time()."','$amount\$')");
				...
				mysql_query("INSERT INTO transactions VALUES ('id','".$userid."','Safepay payment - Banner Impressions','".time()."','$amount\$')");
				...
				mysql_query("INSERT INTO transactions VALUES ('id','".$userid."','Safepay payment - Top Navigation link','".time()."','$amount\$')");
				
				while($quantity > 0) {
					mysql_query("INSERT INTO `navtop` ( `userid` , `date`) VALUES ('".$userid."', '".time()."')");
					$quantity--;
				}
				
			} elseif($item == $sitename." Bottom Navigation Link ".$userid) {
				mysql_query("INSERT INTO transactions VALUES ('id','".$userid."','Safepay payment - Bottom Navigation link','".time()."','$amount\$')");
				
				while($quantity > 0) {
					mysql_query("INSERT INTO `navbot` ( `userid` , `date`) VALUES ('".$userid."', '".time()."')");
					$quantity--;
				}
				
			} elseif($item == $sitename." Login Ad ".$userid) {
				mysql_query("INSERT INTO transactions VALUES ('id','".$userid."','Safepay payment - Login ad','".time()."','$amount\$')");
	...
	mysql_query("INSERT INTO transactions VALUES ('id', '".$userid."','Safepay payment - Button Banner Ad','".time()."','$amount\$')");
		...
		mysql_query("INSERT INTO transactions VALUES ('id','".$userid."','Safepay payment - Daily Bonus $rented','".time()."','$amount\$')");	
											
				
			} elseif($item == $sitename." Traffic link 50 ".$userid) {
				mysql_query("INSERT INTO transactions VALUES ('id','".$userid."','Safepay payment - Traffic link 50','".time()."','$amount\$')");
				...
				mysql_query("INSERT INTO transactions VALUES ('id','".$userid."','Safepay payment - Traffic link 100','".time()."','$amount\$')");
				...
				mysql_query("INSERT INTO transactions VALUES ('id','".$userid."','Safepay payment -  Traffic link 200','".time()."','$amount\$')");
				...
				mysql_query("INSERT INTO transactions VALUES ('id','".$userid."','Safepay payment - PTC 50','".time()."','$amount\$')");
				...
				mysql_query("INSERT INTO transactions VALUES ('id','".$userid."','Safepay payment - PTC 100','".time()."','$amount\$')");
				...
				mysql_query("INSERT INTO transactions VALUES ('id','".$userid."','Safepay payment -  PTC 200','".time()."','$amount\$')");
				...
				mysql_query("INSERT INTO transactions VALUES ('id', '".$userid."','Safepay payment - ".$quantity." solo footer ad','".time()."','$payment_amount\$')");
				...
				$rented = $_POST['custom2'];
				mysql_query("insert into fullloginads (userid,rented,purchase) values('$userid','$rented',NOW())");

				mysql_query("INSERT INTO transactions VALUES ('id','".$userid."','Safepay payment - Full Page Login Ad $rented','".time()."','$amount\$')");	
				

			} elseif($item == $sitename." Featured Ad ".$userid) {
			
				$featuredadmaxhits = $_POST['custom2'];
				mysql_query("insert into featuredads (userid,max,purchase) values('$userid','$featuredadmaxhits',NOW())");

				mysql_query("INSERT INTO transactions VALUES ('id','".$userid."','Safepay payment - Featured Ad $featuredadmaxhits Impressions','".time()."','$amount\$')");	
				

			} elseif($item == $sitename." Hot Headline Ad ".$userid) {
				$hheadlineadmaxhits = $_POST['apc_2'];
				mysql_query("INSERT INTO transactions VALUES ('id','".$userid."','Alertpay payment - Hot Headline Ad $hheadlineadmaxhits Impressions','".time()."','$amount\$')");	
				while($quantity > 0) {
				...
				mysql_query("INSERT INTO transactions VALUES ('id','".$userid."','Alertpay payment - Hot Header Ad $hheaderadmaxhits Clicks','".time()."','$amount\$')");
				while($quantity > 0) {
				...
				mysql_query("INSERT INTO transactions VALUES ('id','".$userid."','Safepay payment - Hot Link','".time()."','$amount\$')");
				
					mysql_query("insert into hotlinks (userid,max) values('$userid','5000')");		
					
			} elseif($item == $sitename." Hot Link Pack 2 ".$userid) {
				mysql_query("INSERT INTO transactions VALUES ('id','".$userid."','Safepay payment - Hot Link 2','".time()."','$amount\$')");
				
					mysql_query("insert into hotlinks (userid,max) values('$userid','10000')");	

			} elseif($item == $sitename." Hot Link Pack 3 ".$userid) {
				mysql_query("INSERT INTO transactions VALUES ('id','".$userid."','Safepay payment - Hot Link 3','".time()."','$amount\$')");
				...
				mysql_query("INSERT INTO transactions VALUES ('id','".$userid."','Safepay payment - " . $middlelevel . " Member Upgrade','".time()."','$amount\$')");

				upgrade_jv($userid);

			}  elseif($item == $sitename." " . $toplevel . " Membership ".$userid) {

				mysql_query("INSERT INTO transactions VALUES ('id','".$userid."','Safepay payment - " . $toplevel . " Upgrade','".time()."','$amount\$')");
				...
				mysql_query("INSERT INTO transactions VALUES ('id', '".$userid."','Safepay payment - Special Offer Ad Package','".time()."','$amount\$')");
 ...
 elseif($item == $sitename." Special Offer") {
				...
				mysql_query("INSERT INTO transactions VALUES ('".$userid."','Safepay payment - Special Offer','".time()."','$amount\$')");
