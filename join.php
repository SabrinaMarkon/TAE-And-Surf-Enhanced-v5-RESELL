...
// ban
if ($_SERVER['REMOTE_ADDR'] == "123.100.138.21") {
   echo "<font size=3 face='$fonttype' color='$fontcolour'><p><b><center>You have been banned.</p><b></center></font>";
   exit;
   }
...
if($jvsignup) {
	...
	$query .= "(userid,pword,name,lastname,contact_email,subscribed_email,status,referid,points,surfcredits,memtype,solos,ip,joindate,referrer,lastsolopost,lastmonthlybonus,nextmonthlybonus) ";
	$query .= "VALUES ";
	$query .= "('$new_userid','$new_password','$new_fullname','$new_lastname','$new_contact','$new_subscribed',1,'$referid','$points','$surfcredits','$mtY',$solo,'$ip','$today','".$_POST['referrer']."','$yesterday',NOW(),DATE_ADD(NOW(),INTERVAL 1 MONTH))";
...
if ($adminnotice=="1") {
	...
	<font size=2 face="<? echo $fonttype; ?>" color="<? echo $fontcolour; ?>" ?><b><center>Signup Successfull!<br><BR>
